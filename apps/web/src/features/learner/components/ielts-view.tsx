    ...
    <>
      ...
      <section aria-labelledby="bands-title">
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,2fr)]">
          <ScoreCard label="Overall" score={null} scale="ielts_band" size="hero" caption="Complete an IELTS practice to get your first estimate." />
          <div className="grid gap-4 sm:grid-cols-2">
            {modules.map((m) => (
              <ScoreCard key={m} label={m} score={null} scale="ielts_band" />
            ))}
          </div>
        </div>
      </section>
      ...
      <section aria-labelledby="continue-title" className="mt-10">
        ...
        <EntitlementGate feature="ielts.mode" fallback={<IELTSUpgrade />}>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <ModeCard icon={Timer} title="Full Mock Exam" text="All four modules under real timing." meta="2 h 45 min" />
          </div>
        </EntitlementGate>
      </section>
